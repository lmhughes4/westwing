...
var CodeFlower = function(selector, w, h) {
  ...
  this.svg.append("svg:rect")
    .style("stroke", "#999") // changes colour of box outline
    .style("fill", "#fff") // changes colour of background of box
    .attr('width', w)
    .attr('height', h);
...
CodeFlower.prototype.update = function(json) {
  ...
  this.node.enter().append('svg:circle')
    ...
    // ** to access an attribute in the JSON file, type d.*attribute*
